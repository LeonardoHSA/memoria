...
mixin _$RecordesRepository on RecordesRepositoryBase, Store {
  late final _$recordesInsanoAtom =
      Atom(name: 'RecordesRepositoryBase.recordesInsano', context: context);

  @override
  Map<dynamic, dynamic> get recordesInsano {
    _$recordesInsanoAtom.reportRead();
    return super.recordesInsano;
  }

  @override
  set recordesInsano(Map<dynamic, dynamic> value) {
    _$recordesInsanoAtom.reportWrite(value, super.recordesInsano, () {
      super.recordesInsano = value;
    });
  }
