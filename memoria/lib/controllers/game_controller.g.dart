...
mixin _$GameController on GameControllerBase, Store {
  ...
  late final _$gameCardAtom =
      Atom(name: 'GameControllerBase.gameCard', context: context);

  @override
  List<GameOpcao> get gameCard {
    _$gameCardAtom.reportRead();
    return super.gameCard;
  }

  @override
  set gameCard(List<GameOpcao> value) {
    _$gameCardAtom.reportWrite(value, super.gameCard, () {
      super.gameCard = value;
    });
  }
